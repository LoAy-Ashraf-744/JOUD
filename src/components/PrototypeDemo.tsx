            ...
            <div className="container px-4">
                <ScrollAnimation initialClass="opacity-0 -translate-x-10" animationClass="opacity-100 translate-x-0">
                    ...
                    <div className="rounded-xl border border-white/10 bg-card overflow-hidden shadow-2xl max-w-6xl mx-auto flex flex-col md:flex-row h-auto md:h-[700px]">
                                        ...
                                        <div className="space-y-2">
                                            {["Tameem", "Salah", "Moaz", "Maher"].map((agent) => (
                                                <button
                                                    ...
                                                    className={`w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${selectedAgent === agent ? "bg-purple-600 text-white" : "text-muted-foreground hover:bg-white/5"
                                                        }`}
                                                >
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            <button
                                                ...
                                                className={`w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${activeView === "products" ? "bg-purple-600 text-white" : "text-muted-foreground hover:bg-white/5"}`}
                                            >
                                            ...
                                            <button
                                                ...
                                                className={`w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${activeView === "gallery" ? "bg-purple-600 text-white" : "text-muted-foreground hover:bg-white/5"
                                                    }`}
                                            >
                        ...
                        <div className="w-full border-b border-white/10 bg-card/50 p-4 flex flex-col gap-4 md:hidden">
                            {/* Mobile Agent Selector */}
                            <div>
                                <h3 className="text-xs font-semibold text-muted-foreground mb-2 uppercase tracking-wider">Agents</h3>
                                <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-none">
                                    {["Tameem", "Salah", "Moaz", "Maher"].map((agent) => (
                                        <button
                                            key={agent}
                                            onClick={() => setSelectedAgent(agent)}
                                            className={`flex-shrink-0 flex items-center gap-2 px-3 py-1.5 rounded-full transition-colors border ${selectedAgent === agent
                                                ? "bg-purple-600/20 border-purple-500 text-purple-600 dark:text-purple-400"
                                                : "bg-white/5 border-white/10 text-muted-foreground"
                                                }`}
                                        >
                                            <div className={`w-1.5 h-1.5 rounded-full ${selectedAgent === agent ? "bg-green-500" : "bg-gray-500"}`} />
                                            <span className="text-sm font-medium">{agent}</span>
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <button
                                    onClick={handleViewProducts}
                                    className={`flex items-center justify-center gap-2 px-3 py-2 rounded-lg transition-colors border ${activeView === "products"
                                        ? "bg-purple-600 border-purple-600 text-white"
                                        : "bg-transparent border-transparent text-muted-foreground active:bg-white/5"
                                        }`}
                                >
                                    <LayoutTemplate className="w-4 h-4" />
                                ...
                                <button
                                    onClick={handleViewGallery}
                                    className={`flex items-center justify-center gap-2 px-3 py-2 rounded-lg transition-colors border ${activeView === "gallery"
                                        ? "bg-purple-600 border-purple-600 text-white"
                                        : "bg-transparent border-transparent text-muted-foreground active:bg-white/5"
                                        }`}
                                >
                        ...
                        <div className="flex-1 bg-background/50 flex flex-col">
                            {/* Top Bar for Gallery - Removed Sorting System */}
                            {activeView === "gallery" && (
                                <div className="h-16 border-b border-white/10 flex items-center px-6 gap-4">
                                    <h3 className="text-lg font-bold">Final Gallery</h3>
                                </div>
                            )}
